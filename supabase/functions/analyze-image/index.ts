...
serve(async (req) => {
  ...
  try {
    ...
    if (visionData.responses && 
        ...
        visionData.responses[0].localizedObjectAnnotations.length > 0) {
    ...
    // In a real-world scenario, this would be replaced with actual price lookups
